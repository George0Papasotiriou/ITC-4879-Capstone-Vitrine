...
const EXPECTED: Record<Role, Record<Permission, boolean>> = {
  customer: { "orders:own": true, "orders:manage": false, "reviews:moderate": false, "catalog:edit": false, "users:manage": false, "outbox:read": false, "reports:read": false, "audit:read": false, "ai:manage": false, "reports:generate": false, "support:work": false },
  support: { "orders:own": true, "orders:manage": true, "reviews:moderate": true, "catalog:edit": false, "users:manage": false, "outbox:read": false, "reports:read": false, "audit:read": false, "ai:manage": false, "reports:generate": false, "support:work": true },
  merchandiser: { "orders:own": true, "orders:manage": false, "reviews:moderate": true, "catalog:edit": true, "users:manage": false, "outbox:read": false, "reports:read": true, "audit:read": false, "ai:manage": false, "reports:generate": false, "support:work": false },
  admin: { "orders:own": true, "orders:manage": true, "reviews:moderate": true, "catalog:edit": true, "users:manage": true, "outbox:read": true, "reports:read": true, "audit:read": true, "ai:manage": true, "reports:generate": true, "support:work": true },
};
